...
4. **Coordinator stays a coordinator — including for content, not just diagnosis.** None of the above means doing the diagnostic/build work yourself instead of delegating it — see `REQUIREMENTS.md` R1/R2. As of 2026-08-01 (R10) this also covers content authoring: drafting Second Brain notes, page copy, and file-organization schemes delegate too, not just research/code. Going "deep" means the delegated work is deep, not that the coordinator absorbs it.
